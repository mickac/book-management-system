...
urlpatterns = [
    ...
    path('book_advanced_searching', views.book_advanced_searching, name='book_advanced_searching'),
    path('feed_from_google', views.feed_from_google, name='feed_from_google'),
