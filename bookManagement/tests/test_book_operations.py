...
class TestBookOperations(unittest.TestCase):
    ...
    def test_advanced_search(self):
        ...
        validSearchTestAny = BookOperations.advanced_search(
                                                    validSearchFAny)
        ...
        validSearchTestAllParam1 = BookOperations.advanced_search(
                                                    validSearchFAllParam1)
        ...
        validSearchTestAllParam2 = BookOperations.advanced_search(
                                                    validSearchFAllParam2)
